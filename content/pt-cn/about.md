...
Currently, I'm working in [BIOMECHANICAL AND IMAGE GUIDED SURGICAL SYSTEMS (BIGSS)](https://bigss.lcsr.jhu.edu/) laboratory under the supervision of [Prof. Mehran Armand](https://scholar.google.com/citations?user=0jQj6m4AAAAJ&hl=en), [Prof. Amir Kheradmand](), and [Prof. Alejandro Martin-Gomez](https://engineering.jhu.edu/faculty/alejandro-martin-gomez/).

***
<div class="compact-under-headers" style="line-height:1.4;">

<style>
	/* Page-local spacing: add a modest gap before each h3 instead of using <br> */
	.compact-under-headers h3 {
		margin-top: 6rem; /* adjust this value if you want more/less space */
		margin-bottom: 1.4rem;
	}
	/* tighten the first paragraph after a heading slightly */
	.compact-under-headers h3 + p {
		margin-top: 0.25rem;
	}
</style>
...
<p style="text-align:left;">&nbsp; &nbsp; Ph.D. in Computer Science <span style="float:right;">Sept. 2023 - Present</span></p>
<p style="text-align:left;"><b>Johns Hopkins University</b><span style="float:right;">Baltimore, MD, USA</span></p>
<p style="text-align:left;">&nbsp; &nbsp; M.S.E. in Robotics, GPA 3.72/4.00<span style="float:right;">Aug. 2021 - Aug. 2023</span></p>
...
- 3D Stereo Camera Hand-eye Calibration

<p><b>Johnson & Johnson MedTech</b></p>

- Benchmarking of Teleop Algorithms
- Build a simulated environment for surgical robots
...
[<i class="fa fa-2x fa-cloud-download"></i> <b>Download my CV</b>](/files/CV_JiamingZhang.pdf "Download pdf")
